        ...
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7">
            <nav className="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6 md:px-8 mx-auto" aria-label="Global">
                <div className="md:col-span-3">
                    <Link className="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="./" aria-label="Preline">
                ...
                <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6">
                    <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
                        <div>
                            <Link className={currentPage === "home" ? activePageClassnames : inactivePageClassnames} href="/">Inicio</Link>
                        </div>
                        <div>
                            <Link className={currentPage === "products" ? activePageClassnames : inactivePageClassnames} href="/products?page=1&page_size=5">Productos</Link>
                        </div>
                    </div>
                </div>
            </nav>
